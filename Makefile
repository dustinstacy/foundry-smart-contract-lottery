...
deploy-sepolia :
	@forge script script/deployLottery.s.sol:DeployLottery --rpc-url $(SEPOLIA_RPC_URL) --account defaultKey --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv